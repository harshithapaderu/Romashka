    ...
    <div class="row display-table-row">
        <div class="col-md-2 col-sm-1 hidden-xs display-table-cell v-align box" id="navigation" style="background-color: #05935d !important;">
            ...
            <div class="navi" >
                ...
                <ul>
                    <li style="background-color: white;"><a href="../index.php" style="background-color: transparent;"><img src="../images/logo.png" style="height: 70px; width: 220px; padding: 10px;" ></a></li>
