                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-7 col-ms-7 col-xs-12 myCols">
                            ...
                            <div class="container5">
                                ...
                                <button type="button" class="btn btn-success btn-block" style="width:50%" onclick="window.location.href = 'https://romashka.foxycart.com/cart?name=Cool%20Example&price=10&color=red&code=sku123'"> Buy </button>
                                <script>
